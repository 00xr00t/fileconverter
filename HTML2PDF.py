...
def convert_html_pdf():
        ...
        if pencere.filename == "" or None:
                showinfo(message="Lütfen önce bir dosya seçiniz.")
        elif pencere.filename == None:
                return
        else:
                kayit_yeri = filedialog.asksaveasfilename(initialfile=new_file, defaultextension=".pdf", filetypes=[("Pdf Files","*.pdf")])
                if kayit_yeri != "":
...
def convert_excel_pdf():
        ...
        if pencere.filename_excel == "" :
                showinfo(message="Lütfen önce bir dosya seçiniz.")
        elif pencere.filename_excel == None:
                return
        else:
...
#-------------------------------------------------------------------------------------------------
def kapat():
        if tk.messagebox.askokcancel("Çık", "Çıkmak mı istiyorsun ?"):
                pencere.destroy()
        else:
                return
